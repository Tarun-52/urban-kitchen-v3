...
export default function CustomersTab({
  ...
  const openEditUser = (u: any) => { setEditUser(u); setUserForm({ name: u.name, email: u.email, phone: u.phone || '', password: '', roleId: u.roleId || u.role?.id || '', status: u.status }); setUserDialog(true) }
