...
import {
  ...
  ArrowRight, LayoutGrid, Send, Zap, Newspaper, MapPin,
...
export const emptyBlogForm: BlogForm = {
  ...
  category: '', categoryId: '', tags: '', status: 'draft', featured: false,
  ...
  sections: [
    {
      ...
      items: [
        ...
        { key: 'employee-live-location', label: 'Employee Live Location', icon: MapPin},
      ],
    },
  ],
}
...
export {
  ...
  Filter, Megaphone, Webhook, FormInput, Database,
  TrendingDown, Timer, CalendarClock, FileSpreadsheet,
  ArrowRight, LayoutGrid, Send, Zap, Newspaper,
}
