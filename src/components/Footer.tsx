        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex flex-col gap-2">
              <a href="tel:+917080488840" className="flex items-center gap-2 text-gray-500 hover:text-[#E8A33C] text-sm transition-colors">
                <Phone className="w-4 h-4" />
                +91-7080488840
              </a>
              <a href="https://wa.me/917080488840" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-500 hover:text-[#E8A33C] text-sm transition-colors">
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-[#E8A33C]" aria-hidden="true">
              ...
              <a href="mailto:info@urbankitchens.com" className="flex items-center gap-2 text-gray-500 hover:text-[#E8A33C] text-sm transition-colors">
          ...
          <div>
            ...
            <div className="w-8 h-0.5 bg-[#E8A33C] mb-4" />
            <ul className="flex flex-col gap-2">
              {quickLinks.map((link) => (
                <li key={link.view}>
                  <button
                    onClick={() => setView(link.view)}
                    className="text-gray-500 hover:text-[#E8A33C] text-sm transition-colors flex items-center gap-1.5 group"
                  >
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              />
              <Button className="bg-[#E8A33C] text-black hover:bg-[#E8A33C]/90 h-9 px-3 shrink-0">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a href="#" className="w-9 h-9 rounded-lg bg-[#151515] border border-[#2a2a2a] flex items-center justify-center text-gray-500 hover:text-[#E8A33C] hover:border-[#E8A33C]/30 transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-gray-600">
          ...
          <div className="flex items-center gap-4">
            <button className="hover:text-[#E8A33C] transition-colors">Privacy Policy</button>
            <button className="hover:text-[#E8A33C] transition-colors">Terms of Service</button>
