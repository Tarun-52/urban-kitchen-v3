...
// POST /api/attendance - Check in/out with live location
  ...
  try {
    ...
    if (action === 'checkin') {
      ...
      const record = await db.attendance.create({
        data: {
          ...
          checkin: new Date(),
          status: 'present',
          checkinLatitude: latitude ? parseFloat(String(latitude)) : null,
          checkinLongitude: longitude ? parseFloat(String(longitude)) : null,
    ...
    if (action === 'checkout') {
      ...
      const record = await db.attendance.update({
        ...
        data: {
          checkout: new Date(),
          checkoutLatitude: latitude ? parseFloat(String(latitude)) : null,
          checkoutLongitude: longitude ? parseFloat(String(longitude)) : null,
