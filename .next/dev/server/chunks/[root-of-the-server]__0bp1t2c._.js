...
async function hashPassword(password) {
    const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, SALT_ROUNDS);
    return hash;
}
async function verifyPassword(password, hash) {
    const match = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(password, hash);
    return match;
}
}),
...
async function PUT(request) {
    try {
        ...
        const customerRole = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].role.findUnique({
            where: {
                roleName: "customer"
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bp1t2c._.js.map